    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8">
      ...
      <div className="flex flex-col-reverse md:flex-row gap-10 md:gap-16 my-12 items-center">
        <div className="flex flex-col justify-center gap-6 md:w-1/2 text-base text-gray-700">
          <p>
            We understand how stressful managing your health can be — that’s why MediNexus is here to help.
          ...
          <p>
            MediNexus blends technology with compassion to deliver excellence in healthcare.
          ...
          <p>
            MediNexus envisions a future where technology transforms healthcare into a seamless experience.
